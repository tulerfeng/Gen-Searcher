...
class TerminationEvent(Exception):
    def __init__(
        self,
        reason: TerminationReason = TerminationReason.UNKNOWN,
        *,
        ...
        self.vision_prompt_length = vision_prompt_length
        self.per_image_vision_token_counts = per_image_vision_token_counts or []
